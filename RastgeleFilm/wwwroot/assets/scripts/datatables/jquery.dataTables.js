...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		 ...
		 * (i.e. "Gosteriliyor 1 to 10 of 57 girdiler") DataTables will render large numbers
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default Gosteriliyor _START_ to _END_ of _TOTAL_ girdiler
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfo": "Gosteriliyor _START_ to _END_ of _TOTAL_ girdiler",
			 ...
			 *  @type string
			 *  @default Gosteriliyor 0 to 0 of 0 girdiler
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Gosteriliyor 0 to 0 of 0 girdiler",
